...
The personal website and digital garden of Ojasw Upadhyay.
...
- **Interactions**: Interactive client-side Mermaid diagrams, static KaTeX math typesetting, and smooth native page routing.

For developer documentation, command references, and deployment configurations, refer to [docs/walkthrough.md](docs/walkthrough.md).
