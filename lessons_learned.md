...
2026-07-05,"Renaming Astro Content Collections","Renaming front-facing concepts requires updating content loaders, folder structures, navigation links, layout back-links, and templates in lockstep to maintain type-safe data loading","Ensure content config base paths and all getCollection calls are renamed simultaneously to keep static page generation working"
```
